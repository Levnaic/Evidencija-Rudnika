    ...
    <div class="formaKartica">
        <form method="POST" action="/kontrola-rudnika/azuriraj-rudnik?id=<?php echo $red->id; ?>">
            ...
            <select name="vrstaRude" id="vrstaRude">
                <option value="bakar" <?php echo ($red->vrstaRude === 'bakar') ? 'selected' : ''; ?>>Bakar</option>
                <option value="ugalj" <?php echo ($red->vrstaRude === 'ugalj') ? 'selected' : ''; ?>>Ugalj</option>
                <option value="zlato" <?php echo ($red->vrstaRude === 'zlato') ? 'selected' : ''; ?>>Zlato</option>
                <option value="srebro" <?php echo ($red->vrstaRude === 'srebro') ? 'selected' : ''; ?>>Srebro</option>
            </select>
